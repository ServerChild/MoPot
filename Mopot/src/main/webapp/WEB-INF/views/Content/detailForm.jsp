...
<body>
    ...
    <section class="content-detail">
        ...
        <script>
            ...
            function insertReplyReply(ref, reStep, reLevel) {
                var ref = parseInt($("#ref-" + reNo).val(), 10);
                var reStep = parseInt($("#reStep-" + reNo).val(), 10)+1;
                var reLevel = parseInt($("#reLevel-" + reNo).val(), 10)+1;
                $.ajax({
                    url: "insertReplyForm.bo",
                    data: {
                        "refCno": "${content.conNo}",
